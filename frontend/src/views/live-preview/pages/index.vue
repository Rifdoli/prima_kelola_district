...
<template>
    <header id="home">
        <BNav class="navbar navbar-expand-md navbar-light default">
            <div class="container">
                ...
                <button @click="toggleMenu" class="navbar-toggler rounded" type="button" data-bs-toggle="collapse"
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav ms-auto mt-lg-0 mt-2 mb-2 mb-lg-0 align-items-start">
                        ...
                        <li class="nav-item px-1">
                            <a class="nav-link" href="https://moonthemes-3.gitbook.io/moon-able-bootstrap/"
                                target="_blank">Documentation</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav mb-2 mb-lg-0 align-items-start">
                        <BDropdown variant="link-secondary" class="card-header-dropdown pb-0 pe-2"
                            ...
                            <template #button-content><span class="text-muted"><i
                                        :class="currentMode === 'dark' ? 'ph-duotone ph-moon' : (currentMode === 'light' ? 'ph-duotone ph-sun-dim' : 'ph-duotone ph-sun-dim text-warning')"></i></span>
                            </template>
                        ...
                        <li class="nav-item">
                            <a href="https://themes.com/item/moon-able-bootstrap-admin-dashboard/" target="_blank"
                                class="btn btn-primary buynowlinks">Get Light able <i
        ...
        <div class="container-fluid">
            <div class="bg-dark mx-sm-3 home-section home-section-2">
                <img src="@/assets/images/landing/img-header-bg.svg" alt="background shape"
                                ...
                                <div class="col-sm-12 header-content">
                                    ...
                                    <div class="wow animate__fadeInUp" data-wow-delay="0.8s">
                                        ...
                                        <a href="https://1.envato.market/EKD9M4"
                                            class="btn btn-outline-light buynowlinks" target="_blank">
                                            Buy Now
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                                    ...
                                    <a class="nav-link" id="technology-tab-2" data-bs-toggle="tab"
                                        ...
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="@/assets/images/landing/techcard-react.svg"
                                    ...
                                    <a class="nav-link" id="technology-tab-3" data-bs-toggle="tab"
                                        ...
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="@/assets/images/landing/techcard-vue.svg" alt="images"
                                                            class="tech-img">
                                                    </div>
                                                    <div class="flex-grow-1 mx-2">
                                    ...
                                    <a class="nav-link" id="technology-tab-4" data-bs-toggle="tab"
                                        ...
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="@/assets/images/landing/techcard-laravel.svg"
                                                            alt="images" class="tech-img">
                                                    </div>
                                                    <div class="flex-grow-1 mx-2">
                                    ...
                                    <a class="nav-link" id="technology-tab-5" data-bs-toggle="tab"
                                        ...
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="@/assets/images/landing/techcard-node.svg"
                                                            alt="images" class="tech-img">
                                                    </div>
                                                    <div class="flex-grow-1 mx-2">
                                    ...
                                    <a class="nav-link" id="technology-tab-6" data-bs-toggle="tab"
                                        ...
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="@/assets/images/landing/techcard-django.svg"
                                                            alt="images" class="tech-img">
                                                    </div>
                                                    <div class="flex-grow-1 mx-2">
                                    ...
                                    <a class="nav-link" id="technology-tab-8" data-bs-toggle="tab"
                                        ...
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="@/assets/images/landing/techcard-cakephp.svg"
                                                            alt="images" class="tech-img">
                                                    </div>
                                                    <div class="flex-grow-1 mx-2">
                                    ...
                                    <a class="nav-link" id="technology-tab-9" data-bs-toggle="tab"
                                        ...
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="@/assets/images/landing/techcard-mvc5.svg"
                                                            alt="images" class="tech-img">
                                                    </div>
                                                    <div class="flex-grow-1 mx-2">
                                    ...
                                    <a class="nav-link" id="technology-tab-10" data-bs-toggle="tab"
                                        ...
                                        <div class="card technology-card wow animate__fadeInUp section-title"
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="@/assets/images/landing/techcard-figma.svg"
                                                            alt="images" class="tech-img">
                                                    </div>
                                                    <div class="flex-grow-1 mx-2">
                ...
                <div class="col-md-8 col-xl-9">
                    ...
                    <div class="tab-content tech-links" id="myTabContent">
                        <!-- Bootstrap -->
                        <div class="tab-pane fade show active" id="technology-tab-pane-1" role="tabpanel"
                            ...
                            <div class="row g-4 text-center">
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="dashboard/index.html" target="_blank">
                                                <img src="@/assets/images/landing/preview-layouts-vertical.jpg"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    <a href="demo/layout-vertical.html" target="_blank"
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-horizontal.html" target="_blank">
                                                <img src="@/assets/images/landing/preview-layouts-horizontal.jpg"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-compact.html" target="_blank">
                                                <img src="@/assets/images/landing/preview-layouts-compact.jpg" alt="img"
                                ...
                                <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.3s">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-creative.html" target="_blank">
                                                <img src="@/assets/images/landing/preview-layouts-creative.jpg"
                                                    alt="img" class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-tab.html" target="_blank">
                                                <img src="@/assets/images/landing/preview-layouts-tab.jpg" alt="img"
                                                    class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-vertical-tab.html" target="_blank">
                                                <img src="@/assets/images/landing/lay-vertical-tab.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                                    <a href="demo/layout-vertical-tab.html" target="_blank"
                                        class="h5 d-flex align-items-center justify-content-center gap-2">Vertical Tab
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-2-column.html" target="_blank">
                                                <img src="@/assets/images/landing/lay-2-column.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                                    <a href="demo/layout-2-column.html" target="_blank"
                                        class="h5 d-flex align-items-center justify-content-center gap-2">2 Column <i
                                            class="ti ti-link text-primary f-22"></i></a>
                                </div>
                                <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.5s">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-big-compact.html" target="_blank">
                                                <img src="@/assets/images/landing/lay-big-compact.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                                    <a href="demo/layout-big-compact.html" target="_blank"
                                        class="h5 d-flex align-items-center justify-content-center gap-2">Big Compact <i
                                            class="ti ti-link text-primary f-22"></i></a>
                                </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-moduler.html" target="_blank">
                                                <img src="@/assets/images/landing/lay-moduler.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-detached.html" target="_blank">
                                                <img src="@/assets/images/landing/lay-detached.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-advanced.html" target="_blank">
                                                <img src="@/assets/images/landing/lay-advanced.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-extended.html" target="_blank">
                                                <img src="@/assets/images/landing/lay-extended.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-dark.vercel.app/dashboard"
                                                target="_blank">
                                                <img src="@/assets/images/landing/preview-page-dark.jpg" alt="img"
                                                    class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/calendar"
                                                target="_blank">
                                                <img src="@/assets/images/landing/preview-app-calendar.jpg" alt="img"
                                                    class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/chat"
                                                target="_blank">
                                                <img src="@/assets/images/landing/preview-app-chat.jpg" alt="img"
                                                    class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/ecom_product"
                                                target="_blank">
                                                <img src="@/assets/images/landing/preview-app-ecommerce.jpg" alt="img"
                                                    class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/mail"
                                                target="_blank">
                                                <img src="@/assets/images/landing/preview-app-inbox.jpg" alt="img"
                                                    class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://light-able-react-light.vercel.app/application/invoice-view"
                                                target="_blank">
                                                <img src="@/assets/images/landing/preview-app-invoice.jpg" alt="img"
                                                    class="img-fluid border">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="row g-4 text-center">
                                ...
                                <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.2s">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="dashboard/index.html" target="_blank">
                                                <img src="@/assets/images/landing/preview-layouts-vertical.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.3s">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="demo/layout-creative.html" target="_blank">
                                                <img src="@/assets/images/landing/preview-layouts-creative.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="technology-tab-pane-10" role="tabpanel"
                            ...
                            <div class="row g-4 text-center">
                                <div class="col-12 text-start">
                                    ...
                                    <p>Can Buy Separately from here: <a
                                            href="https://codedthemes.com/item/light-able-figma-ui-kit/"
                                            target="_blank">Buy
                                            Now</a></p>
                                    <hr class="mt-3 mb-1">
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="card layout-card">
                                        <div class="card-body">
                                            <a href="https://www.figma.com/design/COG9ihMMQKxs7Vmd2EGS8n/Light-Able---Preview?node-id=2-142396&node-type=canvas&t=FmltjFuhqk1iKTMl-0"
                                                target="_blank">
                                                <img src="@/assets/images/landing/preview-figma.jpg" alt="img"
                                                    class="img-fluid border" />
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-8 col-xl-6">
                    ...
                    <p class="mt-lg-4 mt-2 mb-4 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.4s">Unveil the
                        diversity of
                        page layouts within Light Able, including Vertical, Horizontal, and Tab Layouts, each offering
                        unique design options to suit your preferences and project requirements.</p>
                </div>
            </div>
            <div class="row g-4 text-center pages-link">
                <div class="col-lg-4 col-md-6">
                    <div class="card layout-card">
                        <div class="card-body">
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/social-media" target="_blank">
                                <img src="@/assets/images/landing/preview-app-social.jpg" alt="img"
                                    class="img-fluid border">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <a href="/mail" target="_blank"
                        class="h5 d-flex align-items-center justify-content-center gap-2">Inbox
                        <i class="ti ti-link text-primary f-22"></i></a>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card layout-card">
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="gallery-masonry" target="_blank">
                                <img src="@/assets/images/landing/preview-app-gallery.jpg" alt="img"
                                    class="img-fluid border">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <a href="/chat" target="_blank"
                        class="h5 d-flex align-items-center justify-content-center gap-2">Chat
                        <i class="ti ti-link text-primary f-22"></i></a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <router-link to="/components" target="_blank"
                        class="h5 d-flex align-items-center justify-content-center gap-2">Components <i
                            class="ti ti-link text-primary f-22"></i></router-link>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card layout-card">
                        <div class="card-body">
                            <router-link to="/login-v1" target="_blank">
                                <img src="@/assets/images/landing/preview-important-auth-page.jpg" alt="img"
                                    class="img-fluid border">
                            </router-link>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <router-link to="/statistics" target="_blank">
                                <img src="@/assets/images/landing/preview-important-widgets.jpg" alt="img"
                                    class="img-fluid border">
                            </router-link>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <router-link to="/form2_wizard" target="_blank">
                                <img src="@/assets/images/landing/preview-important-wizard.jpg" alt="img"
                                    class="img-fluid border">
                            </router-link>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <router-link to="/account-profile" target="_blank">
                                <img src="@/assets/images/landing/preview-important-account-profile.jpg" alt="img"
                                    class="img-fluid border">
                            </router-link>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <router-link to="/form-element" target="_blank">
                                <img src="@/assets/images/landing/preview-important-form.jpg" alt="img"
                                    class="img-fluid border">
                            </router-link>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <router-link to="/error-404" target="_blank">
                                <img src="@/assets/images/landing/preview-important-error.jpg" alt="img"
                                    class="img-fluid border">
                            </router-link>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/comming-soon" target="_blank">
                                <img src="@/assets/images/landing/preview-important-coming-soon.jpg" alt="img"
                                    class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/contact-us" target="_blank">
                                <img src="@/assets/images/landing/preview-important-contact.jpg" alt="img"
                                    class="img-fluid border">
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 text-center ">
                <div class="col-lg-4 col-md-6">
                    ...
                    <a href="#!" class="h5 d-flex align-items-center justify-content-center gap-2">Dark Version <i
                            class="ti ti-link text-primary f-22"></i></a>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="#!">
                                <img src="@/assets/images/landing/preview-page-rtl.jpg" alt="img"
                                    class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    <a href="#!" class="h5 d-flex align-items-center justify-content-center gap-2">RTL Version <i
                            class="ti ti-link text-primary f-22"></i></a>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="#!">
                                <img src="@/assets/images/landing/preview-page-landing.jpg" alt="img"
                                    class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    <a href="#!" class="h5 d-flex align-items-center justify-content-center gap-2">Landing Page <i
                            class="ti ti-link text-primary f-22"></i></a>
                </div>
            ...
            <div class="row justify-content-center text-center">
                ...
                <div class="col-md-8 col-xl-6">
                    <p class="text-opacity-75 mt-lg-4 mt-2 mb-4 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.4s">
                        ...
                        top
                        features that bundle with Light Able Dashboard Template.</p>
                </div>
            </div>
    ...
    <section class="bg-dark comminuties-section overflow-hidden">
        <div class="container">
            <BRow class="row justify-content-center text-center">
                <div class="col-md-8 col-xl-6">
                    ...
                    <p class="text-white text-opacity-75 mt-lg-4 mt-2 mb-4 mb-md-5 wow animate__fadeInUp"
                        data-aos="fade-up" data-wow-delay="0.4s">
                        We’re proud of the quality products and great service we offer. But don’t just take our word for
                        it—here’s what our happy clients said.</p>
                </div>
            </BRow>
        </div>
        <div class="container-fluid">
            <BRow class="row">
                <div class="col-12 wow animate__fadeInUp" data-aos="fade-up" data-wow-delay="0.6s">
                    <div class="swiper comminuties-slides">
                        <div class="swiper-wrapper">
                            <swiper :pagination="true" class="mySwiper" slides-per-view="3" :space-between="20"
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0">"Error Prohibited!!" Yes, we prioritize your project by conducting
                                        thorough design and
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0">Rest assured, our package stays current with the latest plug-ins and
                                        technologies.
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0">Enjoy stress-free development with separate, regularly updated help
                                        documentation of
                                        Light Able.</p>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card bg-dark counter-block mb-0 wow animate__fadeInUp" data-wow-delay="0.7s">
                        <img src="@/assets/images/landing/img-counter-bg.svg" alt="img"
        ...
        <div class="container">
            <BRow class="row justify-content-center text-center">
                <div class="col-md-8 col-xl-6">
                    ...
                    <p class="mt-lg-4 mt-2 mb-4 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.2s">From budding
                        startups
                        to industry-leading entrepreneurs, our template is shaping the future of great products.</p>
                </div>
                <div class="col-md-12">
                    <BRow class="row justify-content-center client-block g-lg-4 g-3">
                        <div class="col-auto wow animate__fadeInRight" data-aos="fade-right" data-wow-delay="0.3s"><img
                                src="@/assets/images/landing/client-eagames.svg" alt="img" class="img-fluid"></div>
                        <div class="col-auto wow animate__fadeInRight" data-aos="fade-right" data-wow-delay="0.4s"><img
                                src="@/assets/images/landing/client-haswent-2.svg" alt="img" class="img-fluid"></div>
                        <div class="col-auto wow animate__fadeInRight" data-aos="fade-right" data-wow-delay="0.5s"><img
                                src="@/assets/images/landing/client-crystal-1.svg" alt="img" class="img-fluid"></div>
                        <div class="col-auto wow animate__fadeInRight" data-aos="fade-right" data-wow-delay="0.6s"><img
                                src="@/assets/images/landing/client-vodafone.svg" alt="img" class="img-fluid"></div>
                        <div class="col-auto wow animate__fadeInRight" data-aos="fade-right" data-wow-delay="0.7s"><img
                                src="@/assets/images/landing/client-eagames.svg" alt="img" class="img-fluid"></div>
                    </BRow>
                </div>
            </BRow>
                    ...
                    <div class="col-md-4 wow animate__fadeInUp" data-aos="fade-up" data-wow-delay="0.2s">
                        <div class="navbar-brand">
                            <img src="@/assets/images/logo-dark.svg" alt="image"
                                class="img-fluid logo-lg landing-logo mb-3" />
                        </div>
