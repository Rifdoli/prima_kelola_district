...
<template>
                ...
                <BCard no-body class="table-card">
                    <BCardBody>
                        <div class="text-end p-sm-4 pb-sm-2">
                            <router-link to="/add-product" class="btn btn-primary"> <i class="ti ti-plus f-18"></i> Add
                                Product </router-link>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <i class="ph-duotone ph-check-circle text-success f-24"
                                                data-bs-toggle="tooltip" data-bs-title="success"></i>
                                        </td>
                                        <td class="text-center">
                                            <img src="@/assets/images/application/img-prod-brand-1.png" alt="user-image"
                                                class="wid-40">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="@/assets/images/application/img-prod-brand-2.png" alt="user-image"
                                                class="wid-40">
                                            <div class="prod-action-links">
                                                <ul class="list-inline me-auto mb-0">
                                                    <li class="list-inline-item align-bottom" data-bs-toggle="tooltip"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="@/assets/images/application/img-prod-brand-3.png" alt="user-image"
                                                class="wid-40">
                                            <div class="prod-action-links">
                                                <ul class="list-inline me-auto mb-0">
                                                    <li class="list-inline-item align-bottom" data-bs-toggle="tooltip"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="@/assets/images/application/img-prod-brand-4.png" alt="user-image"
                                                class="wid-40">
                                            <div class="prod-action-links">
                                                <ul class="list-inline me-auto mb-0">
                                                    <li class="list-inline-item align-bottom" data-bs-toggle="tooltip"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="@/assets/images/application/img-prod-brand-5.png" alt="user-image"
                                                class="wid-40">
                                            <div class="prod-action-links">
                                                <ul class="list-inline me-auto mb-0">
                                                    <li class="list-inline-item align-bottom" data-bs-toggle="tooltip"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="productOffcanvas" aria-labelledby="productOffcanvasLabel">
        ...
        <div class="offcanvas-body">
            ...
            <p class="text-muted">Image Enlargement: After shooting, you can enlarge photographs of the objects for
                clear zoomed view. Change In Aspect Ratio:
