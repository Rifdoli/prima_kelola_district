                            ...
                            <BCol md="12">
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckCheckedtax"
                                        checked>
                                    <label class="form-check-label" for="flexCheckCheckedtax"> Including all tax
                                    </label>
                                </div>
                                <div class="mb-0">
                ...
                <BCard no-body>
                    ...
                    <BCardBody>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Checkselling3"> Available both in-store and online
                            </label>
                        </div>
                    </BCardBody>
                </BCard>
