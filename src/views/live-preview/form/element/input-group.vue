                    ...
                    <div class="card-body">
                        <div class="alert alert-primary">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3"> Add sizing class
                                    <code>.input-group-sm, .input-group-lg</code> </div>
                            </div>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="card-body">
                        <div class="alert alert-primary">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    Input Group with more options like Button, Button with Dropdown, Colors, Checkbox &
                                    with Radio
                                </div>
                            </div>
                        </div>
