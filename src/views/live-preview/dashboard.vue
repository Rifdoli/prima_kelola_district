            ...
            <BCol md="6" xl="5">
                <BCard no-body>
                    <BCardHeader class="d-flex align-items-center justify-content-between py-3">
                        <h5>Users From United States</h5>
                        <BDropdown variant="link-secondary" class="card-header-dropdown"
                            toggle-class="text-reset dropdown-btn arrow-none avtar avtar-xs"
                            ...
                            <template #button-content><span class="text-muted"><i
                                        class="material-icons-two-tone f-18">more_vert</i></span>
                            </template>
                    ...
                    <BCardBody>
                        ...
                        <apexchart id="earnings-users-chart" height="200" dir="ltr" :series="lineDatalabelChart.series"
