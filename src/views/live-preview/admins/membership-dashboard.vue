            ...
            <div class="col-lg-7 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <apexchart id="revenue-analytics-chart" height="300" type="area" dir="ltr"
                            :series="revenueAnalyticsChart.series" :options="revenueAnalyticsChart.chartOptions">
                        </apexchart>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <apexchart id="membership-state-chart" height="300" type="radialBar" dir="ltr"
                                    :series="membership_state_chart_option.series"
                                    :options="membership_state_chart_option.chartOptions"></apexchart>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <apexchart id="activity-line-chart" height="150" type="line" dir="ltr"
                            :series="activity_line_chart_options.series"
                            :options="activity_line_chart_options.chartOptions"></apexchart>
                    </div>
                </div>
            </div>
