            ...
            <BCol md="7" lg="8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <apexchart id="cashflow-bar-chart" type="bar" height="210" :options="cashflow_bar_chart_options.chartOptions" :series="cashflow_bar_chart_options.series" />
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item px-0">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="@/assets/images/user/avatar-1.jpg" alt="img" class="wid-30 rounded" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <div class="row g-1">
                                            <div class="col-6">
                            ...
                            <li class="list-group-item px-0">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="@/assets/images/user/avatar-2.jpg" alt="img" class="wid-30 rounded" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <div class="row g-1">
                                            <div class="col-6">
